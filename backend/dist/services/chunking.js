...
export function splitIntoChunks(document, chunkSize = DEFAULT_CHUNK_SIZE, overlap = DEFAULT_OVERLAP) {
...
export function rankChunks(question, documents) {
...
export function previewDocumentChunks(document) {
